...
sgd = SGD(lr=1e-3, decay=1e-4, momentum=0.88, nesterov=False)
...
nb_val_samples = 600  # len(val_imgs),
...
model.save_weights('/home/mh/ws/fish_challenge/input/'+'models/frcnn_1_7_5epochs.h5')
